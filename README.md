...
# cs103-S2018-lab4-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Laboratory 4 in Computer Science 103. Since
...
the course textbook, paying close attention to Section 3.5, Figures 3.9 and
3.16, and Table 3.1. Please see the course instructor or one of the teaching
...
- The `index.html` file contains the fragment `<h3>Reviews</h3>`.
...
- The `index.html` file contains the five of the `<blockquote>` fragment to format
  the comments.
- The reflection contains four responses with at least three sentences in each.
- The GitHub repository must contain at minimum five new commits with
  descriptive messages.

The following image gives you an example of the formatting and content that
your final web site should exhibit. Specifically, your web site should display
the provided local image and include five comments that feature a bold-faced
label and a descriptive emoji. Please note that you can open this image in a
new browser tab so that you can inspect it more closely for the required
features.
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-103-S2018/cs103-S2018-lab4-starter.git
```
...
Starter](https://github.com/Allegheny-Computer-Science-103-S2018/cs103-S2018-lab4-starter)
